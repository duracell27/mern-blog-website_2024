        ...
        <div className="flex flex-col justify-between py-2 w-full min-w-[300px]">
          ...
          <div className="flex gap-6 mt-3">
            ...
            <button
              ...
              onClick={(e) => setShowStats((prev) => !prev)}
            >
              Stats
            </button>
...
export const ManageDraftBlogCard = ({ blog }) => {
  let { banner, title, des, blog_id, index, publishedAt, activity } = blog;
  let {userAuth: {access_token}} = useContext(UserContext)
  return (
    <div className="flex gap-5 lg:gap-10 pb-6 border-b mb-6 border-grey">
      <h1
        className="blog-index text-center pl-4 md:pl-6
        flex-none"
      >
...
const deleteBlog = (blog, access_token, target) => {
    ...
    axios.post(import.meta.env.VITE_SERVER_URL + "/delete-blog", {blog_id}, {headers:{
        ...
        setStateFuc(prev=>{
            ...
            return {...prev, totalDocs: totalDocs-1, deletedDocCount: deletedDocCount+1} // firs may be delete second deleted
        })
    }).catch(err=>{
        console.log(err)
    })
