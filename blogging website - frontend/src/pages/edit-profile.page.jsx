...
const EditProfile = () => {
  ...
  useEffect(() => {
    if (access_token) {
      axios
        .post(import.meta.env.VITE_SERVER_URL + "/get-profile", { username })
        .then(({ data }) => {
          setProfile(data);
          setLoading(false);
        })
      ...
      uploadImage(updatedProfileImg)
        .then((url) => {
          if (url) {
            axios
              .post(
                import.meta.env.VITE_SERVER_URL + "/update-profile-img",
                { url },
                {
                  headers: {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post(import.meta.env.VITE_SERVER_URL + "/update-profile", {username, bio, social_links:{youtube,facebook,twitter,github,instagram,website}}, {
          ...
          <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
            <div className="max-lg:center mb-5">
              ...
              >
                ...
                <img ref={profileImgRef} src={profile_img} alt="avatarImg" />
              </label>
              <input
                type="file"
                id="uploadImg"
            ...
            <div className="w-full">
              <div className="grid drid-cols-1 md:grid-cols-2 md:gap-5">
                <div className="">
                  <InputBox
                    name={"fullname"}
                    type={"text"}
